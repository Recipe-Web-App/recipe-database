...
def parse_serving_size(serving_size_str):
    ...
    """
    if pd.isna(serving_size_str) or not serving_size_str or serving_size_str.strip() == '':
        return None, None
...
def clean_numeric_value(value, column_name=None):
    ...
    try:
        ...
        if column_name:
            ...
            elif column_name.endswith('_100g') or column_name == 'nutriscore_score' or column_name == 'serving_quantity':
